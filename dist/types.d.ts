...
export type EnemyBehavior = "slow" | "braced" | "heavy" | "regenerates" | "mimic" | "charger" | "drainer" | "chaotic" | "royal-guard" | "final-boss";
...
export interface EngineEvent {
    readonly type: "turn.action" | "turn.enemy-response" | "turn.level-won" | "turn.defeat" | "turn.complete" | "turn.reset" | "turn.retry" | "arena.tick" | "arena.collision" | "arena.attack";
...
export type EngineErrorCode = "INVALID_COMMAND" | "INVALID_ACTION" | "INSUFFICIENT_ENERGY" | "GAME_NOT_ACTIVE" | "INVALID_SAVE";
...
export type ArenaCommand = {
    readonly type: "arena.set-input";
    readonly entityId: string;
    readonly input: ArenaInput;
} | {
    readonly type: "arena.step";
